...
async function loadServers() {
    ...
    try {
        const _0x292b49 = await fetchServersWithRetry('https://wormatefriendsturkey.com/up/api/server_wmxt.php');
