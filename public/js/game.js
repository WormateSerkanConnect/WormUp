...
async function loadUsers() {
  await fetch("https://wormateserkanconnect.github.io/WormUp/public/api/users.php").then(_0x1acaf1 => _0x1acaf1.json()).then(_0x5cf014 => {
...
async function loadServers() {
  try {
    const _0x3dab4b = await fetchServersWithRetry("https://wormateserkanconnect.github.io/WormUp/public/api/server.php");
...
window.addEventListener("load", function () {
  ...
  window.anApp.p.Bc = function () {
    ...
    $.get("https://resources.wormate.io/dynamic/assets/registry.json", function (_0x390583) {
      _0x30834f = _0x390583;
      $.ajax({
        'url': "https://wormateserkanconnect.github.io/WormUp/public/api/skins.php",
        'method': 'GET',
        'dataType': "json",
